...
const AppleMusic_1 = require("./utils/AppleMusic");
...
class Player extends tiny_typed_emitter_1.TypedEmitter {
    ...
    search(query, options) {
        ...
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (qt) {
                case types_1.QueryType.APPLE_MUSIC_TRACK: {
                    const data = yield (0, AppleMusic_1.search)(query);
                    const videos = yield youtube_sr_1.default.search(data.title, {
                        type: "video"
                    });
                    if (!videos)
                        return null;
                ...
                case types_1.QueryType.APPLE_MUSIC_ALBUM:
                case types_1.QueryType.APPLE_MUSIC_PLAYLIST: {
                    const data = (yield (0, AppleMusic_1.search)(query));
                    ...
                    for (const m of data.tracks) {
                        ...
                        const data = new Track_1.default(this, {
                            title: (_a = videos[0].title) !== null && _a !== void 0 ? _a : "",
                            description: (_b = videos[0].description) !== null && _b !== void 0 ? _b : "",
                            author: (_c = m.artist.name) !== null && _c !== void 0 ? _c : "Unknown Artist",
                            url: videos[0].url,
                            thumbnail: (_d = videos[0].thumbnail.url) !== null && _d !== void 0 ? _d : "https://www.scdn.co/i/_global/twitter_card-default.jpg",
                            duration: videos[0].durationFormatted,
                            views: 0,
                            requestedBy: options.requestedBy,
                            source: "applemusic"
                ...
                case types_1.QueryType.YOUTUBE_VIDEO: {
                    ...
                    const track = new Track_1.default(this, {
                        ...
                        author: (_e = info.videoDetails.author) === null || _e === void 0 ? void 0 : _e.name,
                        url: info.videoDetails.video_url,
                        requestedBy: options.requestedBy,
                        thumbnail: (_f = Util_1.Util.last(info.videoDetails.thumbnails)) === null || _f === void 0 ? void 0 : _f.url,
                ...
                case types_1.QueryType.SPOTIFY_SONG: {
                    ...
                    const spotifyTrack = new Track_1.default(this, {
                        ...
                        description: (_g = spotifyData.description) !== null && _g !== void 0 ? _g : "",
                        author: (_j = (_h = spotifyData.artists[0]) === null || _h === void 0 ? void 0 : _h.name) !== null && _j !== void 0 ? _j : "Unknown Artist",
                        url: (_l = (_k = spotifyData.external_urls) === null || _k === void 0 ? void 0 : _k.spotify) !== null && _l !== void 0 ? _l : query,
                        thumbnail: ((_p = (_o = (_m = spotifyData.album) === null || _m === void 0 ? void 0 : _m.images[0]) === null || _o === void 0 ? void 0 : _o.url) !== null && _p !== void 0 ? _p : (_q = spotifyData.preview_url) === null || _q === void 0 ? void 0 : _q.length)
                            ? `https://i.scdn.co/image/${(_r = spotifyData.preview_url) === null || _r === void 0 ? void 0 : _r.split("?cid=")[1]}`
                ...
                case types_1.QueryType.SPOTIFY_ALBUM: {
                    ...
                    if (!spotifyPlaylist)
                        return { playlist: null, tracks: [] };
                    const playlist = new Playlist_1.Playlist(this, {
                        title: (_s = spotifyPlaylist.name) !== null && _s !== void 0 ? _s : spotifyPlaylist.title,
                        description: (_t = spotifyPlaylist.description) !== null && _t !== void 0 ? _t : "",
                        thumbnail: (_v = (_u = spotifyPlaylist.images[0]) === null || _u === void 0 ? void 0 : _u.url) !== null && _v !== void 0 ? _v : "https://www.scdn.co/i/_global/twitter_card-default.jpg",
                        type: spotifyPlaylist.type,
                        source: "spotify",
                        author: spotifyPlaylist.type !== "playlist"
                            ? {
                                name: (_x = (_w = spotifyPlaylist.artists[0]) === null || _w === void 0 ? void 0 : _w.name) !== null && _x !== void 0 ? _x : "Unknown Artist",
                                url: (_0 = (_z = (_y = spotifyPlaylist.artists[0]) === null || _y === void 0 ? void 0 : _y.external_urls) === null || _z === void 0 ? void 0 : _z.spotify) !== null && _0 !== void 0 ? _0 : null
                            }
                            : {
                                name: (_4 = (_2 = (_1 = spotifyPlaylist.owner) === null || _1 === void 0 ? void 0 : _1.display_name) !== null && _2 !== void 0 ? _2 : (_3 = spotifyPlaylist.owner) === null || _3 === void 0 ? void 0 : _3.id) !== null && _4 !== void 0 ? _4 : "Unknown Artist",
                                url: (_7 = (_6 = (_5 = spotifyPlaylist.owner) === null || _5 === void 0 ? void 0 : _5.external_urls) === null || _6 === void 0 ? void 0 : _6.spotify) !== null && _7 !== void 0 ? _7 : null
                            },
                        tracks: [],
                        id: spotifyPlaylist.id,
                        url: (_9 = (_8 = spotifyPlaylist.external_urls) === null || _8 === void 0 ? void 0 : _8.spotify) !== null && _9 !== void 0 ? _9 : query,
                ...
                case types_1.QueryType.SOUNDCLOUD_PLAYLIST: {
                    ...
                    const res = new Playlist_1.Playlist(this, {
                        title: data.title,
                        description: (_10 = data.description) !== null && _10 !== void 0 ? _10 : "",
                        thumbnail: (_11 = data.thumbnail) !== null && _11 !== void 0 ? _11 : "https://soundcloud.com/pwa-icon-192.png",
                        type: "playlist",
                        source: "soundcloud",
                        author: {
                            name: (_15 = (_13 = (_12 = data.author) === null || _12 === void 0 ? void 0 : _12.name) !== null && _13 !== void 0 ? _13 : (_14 = data.author) === null || _14 === void 0 ? void 0 : _14.username) !== null && _15 !== void 0 ? _15 : "Unknown Artist",
                            url: (_16 = data.author) === null || _16 === void 0 ? void 0 : _16.profile
                        },
                        tracks: [],
                        id: `${data.id}`,
                        url: data.url,
                    ...
                    for (const song of data.tracks) {
                        const track = new Track_1.default(this, {
                            title: song.title,
                            description: (_17 = song.description) !== null && _17 !== void 0 ? _17 : "",
                            author: (_21 = (_19 = (_18 = song.author) === null || _18 === void 0 ? void 0 : _18.username) !== null && _19 !== void 0 ? _19 : (_20 = song.author) === null || _20 === void 0 ? void 0 : _20.name) !== null && _21 !== void 0 ? _21 : "Unknown Artist",
                            url: song.url,
                            thumbnail: song.thumbnail,
                            duration: Util_1.Util.buildTimeCode(Util_1.Util.parseMS(song.duration)),
                            views: (_22 = song.playCount) !== null && _22 !== void 0 ? _22 : 0,
                            requestedBy: options.requestedBy,
                            playlist: res,
                            source: "soundcloud",
                            engine: song
